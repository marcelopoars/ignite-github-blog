...
export function Footer() {
  return (
    <FooterContainer>
      <div>
        <p>
          Este projeto foi desenvolvido para um dos desafios da trilha de
          ReactJs do <strong>Ignite | Rocketseat.</strong>
        </p>
      ...
      <aside>
        <ul>
          <li>
            <a
              href="https://github.com/marcelopoars/ignite-github-blog"
              target="_blank"
              rel="noopener noreferrer"
